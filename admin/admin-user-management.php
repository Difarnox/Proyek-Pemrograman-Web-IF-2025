...
// Contoh data pengguna (nanti bisa diambil dari database users atau tabel pengguna lainnya)
// PENTING: Jangan tampilkan password asli di halaman ini!
$data_pengguna = [
    ["kode"=>"PGN17","nama"=>"Teja","username"=>"admin","password_display"=>"********"],
    ["kode"=>"PENGGUNA - 35","nama"=>"Inggryan","username"=>"inggry","password_display"=>"********"],
];
?>
<!DOCTYPE html>
<html lang="id">
...
<div class="container-fluid py-4">
    ...
    <div class="card p-3 mb-3">
        <div class="table-responsive">
            <table id="tabel-pengguna" class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                <?php foreach($data_pengguna as $i => $p): ?>
                    <tr>
                        <td><?= $i+1 ?></td>
                        <td><?= $p['kode'] ?></td>
                        <td><?= $p['nama'] ?></td>
